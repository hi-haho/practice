...
public class BusinessImpl implements BusinessInter {
	...
	public void groupBuserPrint() {
		System.out.println("\n부서별 인원수");
		List<JikwonDto> list = inter.groupBuser();
		list.forEach(bu->System.out.println(bu.getBuser_name() + " - " + bu.getJikwon_count()));
	}
	@Override
	public void topBuserPayPrint() {
		System.out.println("\n부서별 최대 급여자");
		List<JikwonDto> list = inter.topBuserPay();
		list.forEach(p->System.out.println(p.getBuser_name() + " : " + p.getJikwon_name() + " ( "+p.getJikwon_pay()+" )"));
	}
